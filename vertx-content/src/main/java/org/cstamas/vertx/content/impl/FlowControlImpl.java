 ...
 */
public class FlowControlImpl
    implements FlowControl, Handler<Message<JsonObject>>
{
  ...
  private static final Logger log = LoggerFactory.getLogger(FlowControlImpl.class);
  ...
  public FlowControlImpl setOnBeginHandler(final Handler<JsonObject> onBeginHandler) {
    this.onBeginHandler = onBeginHandler;
    return this;
  }

  public FlowControlImpl setOnPauseHandler(final Handler<JsonObject> onPauseHandler) {
    this.onPauseHandler = onPauseHandler;
    return this;
  }

  public FlowControlImpl setOnResumeHandler(final Handler<JsonObject> onResumeHandler) {
    this.onResumeHandler = onResumeHandler;
    return this;
  }

  public FlowControlImpl setOnEndHandler(final Handler<JsonObject> onEndHandler) {
